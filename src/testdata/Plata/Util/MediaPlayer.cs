...
namespace Media
{
    ...
    public class MP3Player
    {
        ...
        private void CalculateLength()
        {
          ...
          long lErr = mciSendString("status MediaFile length", sb, 128, IntPtr.Zero);
					if ( sb.Length!=0 )
            Length = Convert.ToUInt64(sb.ToString());
        }
        ...
        {
					if ( string.Compare( sFileName, FName, true ) == 0 )
						return true;
