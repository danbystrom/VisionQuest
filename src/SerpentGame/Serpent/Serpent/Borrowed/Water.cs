...
namespace Serpent.Borrowed
{
    ...
    public class Water
    {
            ...
            Vector3 position, Vector2 size)
        {
            ...
            waterMesh = new CModel(content.Load<Model>("models/plane"), position,
            ...
            waterEffect.Parameters["WaterNormalMap"].SetValue(
                content.Load<Texture2D>("textures/water_normal"));
        ...
        public void renderReflection(factor10.VisionThing.Camera camera)
        {
            ...
            var reflectionCamera = new Camera.TargetCamera(
            ...
            var clipPlane = new Vector4(0, 1, 0, -waterMesh.Position.Y);
        ...
        public void PreDraw(factor10.VisionThing.Camera camera, GameTime gameTime)
        {
