...
namespace factor10.VisionThing.Effects
{
    ...
    /// </summary>
    public class StockBasicEffect : Effect, IEffectMatrices, IEffectLights, IEffectFog
    {
        public Vector4 OriginalDiffuseColor;
        ...
        public StockBasicEffect(GraphicsDevice device)
            : base(device, null) //TODO Resources.BasicEffect)
        {
        ...
        protected StockBasicEffect(StockBasicEffect cloneSource)
            : base(null,null) //TODO cloneSource)
        {
        ...
        public Effect Clone()
        {
            return new StockBasicEffect(this);
        }
